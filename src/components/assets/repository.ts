...
class Repository {
  ...
  public static async create(data: Asset): Promise<Asset> {
  ...
  public static async update({ id, ...data }: any): Promise<Asset> {
  ...
  public static async delete(id: string): Promise<Asset> {
    const document = await Model.findById(id).exec();
  ...
  public static async generatedDedicatedData(objects: ReadonlyArray<Asset>): Promise<void> {
...
const transform = (document: Document): Asset => {
